...
var config = {
    ...
    databaseURL: "https://trains-de761.firebaseio.com",
    projectId: "trains-de761",
    storageBucket: "trains-de761.appspot.com",
...
//
  ...
  $("#submit").on("click", function(event) {
    ...
    if ($("#train-name").val().trim() === "" ||
      ...
      alert("Please fill in ALL inputs to add a new train");
